...
public:
	...
	/**
	 * Sets a new maximum velocity in RPM [0-600]. In voltage mode, the max
	 * velocity is ignored and a max voltage should be set on the underlying
	 * ChassisModel instead.
	 *
