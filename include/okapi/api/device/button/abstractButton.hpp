...
public:
	...
	/**
	 * Return whether the state of the button changed to being pressed since the
	 *last time this method was called.
	 **/
	virtual bool changedToPressed() = 0;

	/**
	 * Return whether the state of the button to being not pressed changed since
	 ...
	 *
	 * @return the current sensor value. This is the same as the output of the
	 * pressed() method.
	 */
