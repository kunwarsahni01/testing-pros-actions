...
public:
   ...
   * supplied, a `std::invalid_argument` exception is thrown.
   *
   * @param imotors The motors in this group.
   * @param ilogger The logger this instance will log initialization warnings
   * to.
   */
  MotorGroup(
      const std::initializer_list<Motor> &imotors,
   ...
   * reached: EACCES - Another resource is currently trying to access the port.
   *
